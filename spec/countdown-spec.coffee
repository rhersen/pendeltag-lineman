describe 'Countdown', ->
    ...
    it 'should handle departures far into next hour', ->
        subject = Countdown
            dateTime: "2013-01-02T18:39:00"
            now: new Date(1322153707000)
        result = jasmineReact.renderComponent(subject)
    ...
    it 'should handle departures almost an hour from now', ->
        subject = Countdown
            dateTime: "2013-01-02T18:40:00"
            now: new Date(1322152860100)
        result = jasmineReact.renderComponent(subject)
